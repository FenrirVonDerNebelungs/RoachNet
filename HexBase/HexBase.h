...
namespace n_HexBase {
	...
	bool copyWeave(/*const*/ s_HexPlate* sewnPlate, s_HexPlate* loosePlate);/*sets up loosePlate so that it has an inter hex weave like the sewn plate,  source must have at least as many hexes as the loose plate*/
